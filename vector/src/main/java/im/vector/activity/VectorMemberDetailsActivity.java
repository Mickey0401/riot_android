    ...
    private void updateMemberAvatarUi() {
        if (null != mMemberAvatarImageView) {
            ...
            if (null != mRoomMember) {
                ...
                VectorUtils.loadUserAvatar(this, mSession, mMemberAvatarImageView,null, avatarUrl, mRoomMember.getUserId(), displayname);
            } else {
                // use the user if it is defined
                if (null != mUser) {
                    VectorUtils.loadUserAvatar(this, mSession, mMemberAvatarImageView,null, mUser);
                } else {
                    // default avatar
                    VectorUtils.loadUserAvatar(this, mSession, mMemberAvatarImageView,null, null, mMemberId, mMemberId);
                }
            }
        }
    }
