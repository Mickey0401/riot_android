    ...
    public View getChildView(final int aGroupPosition, final int aChildPosition, boolean isLastChild, View aConvertView, ViewGroup aParentView) {
        ...
        if (null != participant.getAvatarBitmap()) {
            ...
            if (TextUtils.isEmpty(participant.mUserId)) {
                VectorUtils.loadUserAvatar(mContext, mSession, viewHolder.mMemberAvatarImageView,null, participant.mAvatarUrl, participant.mDisplayName, participant.mDisplayName);
            } else {
                ...
                VectorUtils.loadUserAvatar(mContext, mSession, viewHolder.mMemberAvatarImageView,null, participant.mAvatarUrl, participant.mUserId, participant.mDisplayName);
            }
        }
