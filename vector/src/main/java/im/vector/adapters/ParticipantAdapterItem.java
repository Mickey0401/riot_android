    ...
    public void displayAvatar(MXSession session, ImageView imageView) {
        ...
        if (null != getAvatarBitmap()) {
            ...
            if ((null != mUserId) && (android.util.Patterns.EMAIL_ADDRESS.matcher(mUserId).matches()) || !mIsValid) {
                ...
                if (TextUtils.isEmpty(mUserId)) {
                    VectorUtils.loadUserAvatar(imageView.getContext(), session, imageView,null, mAvatarUrl, mDisplayName, mDisplayName);
                } else {
                    ...
                    VectorUtils.loadUserAvatar(imageView.getContext(), session, imageView,null, mAvatarUrl, mUserId, mDisplayName);
                }
            }
        }
    }
